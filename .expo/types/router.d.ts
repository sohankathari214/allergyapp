...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/api/analyze-food/route` | `/forum/page` | `/globals.css` | `/home/layout` | `/home/page` | `/login/page` | `/map/page` | `/page` | `/profile/page` | `/saved-meals/page` | `/scan/page` | `/scan-history/page`;
  // prettier-ignore
